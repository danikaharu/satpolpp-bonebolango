        ...
        <div class="row">
            ...
            <div class="col-lg-8 entries">
                ...
                <article class="entry">
                    ...
                    <div class="entry-img">
                        <img src="{{ asset('assets_user/img/blog/blog-2.jpg') }}" alt="" class="img-fluid">
                    </div>
                ...
                <article class="entry">
                    ...
                    <div class="entry-img">
                        <img src="{{ asset('assets_user/img/blog/blog-3.jpg') }}" alt="" class="img-fluid">
                    </div>
                ...
                <article class="entry">
                    ...
                    <div class="entry-img">
                        <img src="{{ asset('assets_user/img/blog/blog-4.jpg') }}" alt="" class="img-fluid">
                    </div>
