                        ...
                        <div class="entry-meta">
                            <ul>
                                <li class="d-flex align-items-center"><i class="bi bi-person"></i> <a
                                        href="#">{{ $complaint->name }}</a></li>
                                <li class="d-flex align-items-center"><i class="bi bi-clock"></i> <a
                                        href="#"><time>{{ $complaint->created_at->format('d M Y H:i') }}</time></a>
                                </li>
                                    ...
                                    <div class="accordion-body">
                                        @if ($complaint->response)
                                            <div class="entry-meta">
                                                <ul>
                                                    <li class="d-flex align-items-center"><i class="bi bi-person"></i> <a
                                                            href="#">{{ $complaint->response->user->name ?? '' }}</a>
                                                    </li>
                                                    <li class="d-flex align-items-center"><i class="bi bi-clock"></i> <a
                                                            href="#"><time>{{ $complaint->response ? $complaint->response->created_at->format('d M Y H:i') : '' }}</time></a>
                                                    </li>
                                                </ul>
                                            </div>
                                        @endif
