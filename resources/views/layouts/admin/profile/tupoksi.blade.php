...
<ol class="breadcrumb mb-2">
    <h4>
        <li class="breadcrumb-item active fon">Tugas Pokok dan Fungsi</li>
    </h4>
</ol>
        ...
        <div class="col-md-12">
            <div class="card border-0 shadow rounded">
                <div class="card-body">
                    ...
                    <a href="{{ route('tupoksi.edit', $profiles->id) }}" class="btn btn-sm btn-primary"
                        ...
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalLabel">Edit Tupoksi</h5>
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                        <span aria-hidden="true">&times;</span>
                                    </button>
                                </div>

                                <form action="{{ route('tupoksi.update', $profiles->id)}}" method="POST"
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea id="summernote"
                                                ...
                                                name="title" rows="5"
                                                placeholder="Masukan Tugas Pokok">{{ old('title', $profiles->title) }}</textarea>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea id="summernote1"
                                                ...
                                                name="content" rows="5"
                                                placeholder="Masukan Fungsi">{{ old('content', $profiles->content) }}</textarea>
